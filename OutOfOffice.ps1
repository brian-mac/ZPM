...
.Parameter StartDate
Scheduled start time of OOO

.Parameter EndDate
Scheduled end date of OOO
...
#Version number 1.2.2  20170604 14:35
 ...
 param (
    ...
    [Parameter(Mandatory=$True,HelpMessage="Please enter the Start date",Parametersetname = "Set 2")][string] $StartDate ,
    [Parameter(Mandatory=$True,HelpMessage="Please enter the End Date",Parametersetname = "Set 2")][string] $EndDate,
