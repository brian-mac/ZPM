...
$Users = Get-MsolUser -all  | where-object {$_.islicensed -eq $True} | select-object userprincipalname , MobilePhone
$Users | export-csv -path "C:\temp\mobiles.csv"
