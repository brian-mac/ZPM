...
$AGS = Get-ADobject -Filter {memberof -like "ausnz-ags-gapps"} #-SearchBase "OU=AGS,OU=EXTERNAL,DC=talent2,DC=corp" -SearchScope Subtree -properties *
#$InputFile = Import-Csv -Path "C:\temp\AGS_Input.csv"
